...
const WaveAnimation = () => {
  // Define wave paths outside of useEffect
  const wave1 =
  ...
  return (
    <div className=" w-full bg-blue-800">
      <svg className="wave-top z-0 w-full" width="100" viewBox="0 0 800 250">
        <path fillRule="evenodd" clipRule="evenodd" d={wave1} fill="#0099FF" />
      </svg>
    </div>
  );
};
